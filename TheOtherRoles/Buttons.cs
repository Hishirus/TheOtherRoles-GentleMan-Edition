    ...
    static class HudManagerStartPatch
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            securityGuardCamButton = new CustomButton(
                ...
                () =>
                {
                    return SecurityGuard.securityGuard != null && SecurityGuard.securityGuard == CachedPlayer.LocalPlayer.PlayerControl && !CachedPlayer.LocalPlayer.Data.IsDead && SecurityGuard.remainingScrews < Mathf.Min(SecurityGuard.ventPrice, SecurityGuard.camPrice) /*&& !SubmergedCompatibility.IsSubmerged */;
                },
                () =>
                {
